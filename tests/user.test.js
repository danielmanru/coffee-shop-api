...
describe(`POST  ${path}/register`, function () {
  ...
  it("should can register new user", async () => {
    ...
    expect(result.body.data.email).toBe("donaca5537@cerisun.com");
    expect(result.body.data.password).toBeUndefined();
    expect(emailUtil.sendEmail).toHaveBeenCalledWith(
      "donaca5537@cerisun.com",
      "Verify your email",
      expect.stringContaining(
        "We are pleased to welcome you! To get started, please verify your email address by clicking the button below."
      )
    );
  });
...
describe(`PUT ${path}/users/updateUserDetail`, function () {
  ...
  it("should can update users information", async () => {
    ...
    expect(update.body.data.email).toBe("donaca5537@cerisun.com");
